                ...
                <form action="{{ route('opportunities.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control @error('stage') is-invalid @enderror" id="stage" name="stage" required>
                                ...
                                <option value="prospecting" {{ old('stage') == 'prospecting' ? 'selected' : '' }}>Prospecci&oacute;n</option>
                                <option value="qualification" {{ old('stage') == 'qualification' ? 'selected' : '' }}>Cualificaci&oacute;n</option>
                                <option value="proposal" {{ old('stage') == 'proposal' ? 'selected' : '' }}>Propuesta</option>
                                <option value="negotiation" {{ old('stage') == 'negotiation' ? 'selected' : '' }}>Negociaci&oacute;n</option>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save mr-1"></i> Guardar Oportunidad
                        </button>
                    </div>
                </form>
            </div>
